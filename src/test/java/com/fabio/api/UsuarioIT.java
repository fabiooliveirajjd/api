/**
 * Testes de integração para a funcionalidade relacionada aos usuários.
 *
 * Esta classe de teste realiza testes de integração para as operações relacionadas aos usuários, incluindo a criação,
 * busca, edição de senha e listagem de usuários.
 */
...
@Sql(scripts = "/sql/data/usuario/usuarios-insert.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/data/usuario/usuarios-delete.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
